// Recovered 2026-08-18 from the CodeSandbox devbox "Ingestro / [Aceve] Sequential Import Sandbox V2"
// (codesandbox.io/p/devbox/prod-framework-4hyyps) via its webpack source map.
// Deps per the sandbox: @ingestro/importer-react 4.8.5, @my-react/react-dom 0.3.20, xlsx, @types/file-saver 2.0.5
// NOTE: original indentation was lost in transport — run Prettier on this file.
// NOTE: the demo seed arrays companySeeds and peopleSeeds have been trimmed to 2 entries each
//       (synthetic data, 10 entries each in the original). Everything else is verbatim.
...
labels: [
"Företagsnamn*","Person/Org.nr.*","Momsreg.nr.*","Bankgiro*","Plusgiro","Adress*","Adress 2","Adress 3",
"Postnr.*","Ort*","Land","Besöksadress","Besöksadress 2","Besöksadress 3","Telefon","Fax","Epost",
"Webadress","Fakturatext F-skatt*","Fakturatext dröjsmålsränta*",
],
},
{
id: "timpriser",
...
labels: ["Kod","Beskrivning","Enhet","Kostn/enh","Pris/enh","Kontonr","Tidkod","Debiterbar","Grupp"],
},
{
id: "prislista",
name: "Prislista",
...
labels: ["Artikelnr*","Beskrivning*","Enhet*","Kostn/enh*","Pris/enh*","Konto*","Debiterbar",
"Artikelkategori","Lagersaldo","Tidkod","Föräldraprojekt"],
},
{
id: "projekttyper",
name: "Projekttyper",
...
labels: ["ROT-kostnadskonton*","Standardinställning kundfaktura*","Standardtyp ROT/RUT-arbete"],
},
{
id: "lonetillagg",
name: "Lönetillägg",
...
labels: ["Artikelnr*","Beskrivning*","Artikelkategori","Enhet*","Kostn/enh*","Pris/enh*","Konto*",
"Visa i mob enh","Favorit i mobil enh","Ta med offert","Debiterbar","Ägarprojekt","Lagersaldo","Tidkod*"],
},
{
id: "anvandarregister",
...
labels: ["Aktiv*","Anställningsnr","För- och efternamn*","Inloggning*","Användarlicens*","Primär grupp*",
"Yrkesroll (från timpriser)*","Signatur*","E-post","Mobil","Telefon","Namn","Adressrad 1","Adressrad 2",
"Postnr","Ort","Land","Startdatum","Slutdatum","Födelsedatum","Språk","Organisatoriskt projekt",
"Närmaste anhörig","Telefon anhörig","Relation till anhörig","Personnr","Externt orgnr"],
},
{
...
labels: ["Påslagsmall kod*","Påslagsmall beskrivning*","Standard","Kontonr*","Kontobeskrivning","Påslag %*"],
},
{
id: "projekt",
name: "Projektlista",
...
labels: ["Föräldraprojektnr*","Projektnr*","Projektnamn*","Projektstatus*","Projektledare*","Projektstart*",
"Ersättningsform*","Projekttyp","Kund*","Kundkontakt","Kundreferens","Kostnadsställe","Arbetsledare",
"Projektkategori","Typ av uppdrag","Noteringar","Projektslut","Påslagsmall","Adress","Adressrad 2","Ort"],
},
{
id: "kontoplan",
name: "Kontoplan",
...
labels: ["Kontonr*","Beskrivning*","Kostnad*","Fakturera vid import","Moms","Arbete","Extern momskod",
"Artikelnr på faktura","Kontotyp"],
},
{
id: "kunder",
name: "Kundregister",
...
labels: ["Kundnr*","Kund*","Kundtyp*","Valuta*","Person/Orgnr*","Namn*","Adressrad 1","Adressrad 2","Postnr",
"Ort","Land","E-post","Faktura e-post","Telefon","Fax","Fakturatyp","Elektronisk adress","Notering",
"Entreprenadbolag","Ingen moms","Leverantör nr","Betalningsvillkor","IBAN","SWIFT/BIC","Bank","Bankkonto",
"Clearing nr","EAN-kod","VAT-nummer","Landskod","Fastighetsbeteckning","Brf org nr","Lägenhet nr"],
},
{
id: "leverantorer",
name: "Leverantörer",
...
labels: ["Leverantör nr*","Leverantör*","Organisationsnr*","VAT-nummer*","Leverantörstyp*","Valuta*",
"Bankgiro","Plusgiro","Företagskategorier","Regioner","Namn","Adressrad 1","Adressrad 2","Postnr","Ort",
"Land","Landskod","E-post","Telefon","Konto","Webbadress"],
},
{
id: "kundkontakter",
name: "Kundkontakter",
...
labels: ["Kundnr*","Namn*","Personnr","Mobil","Telefon","E-post","Faktura e-post","Roll","Kundref nr",
"Fastighetsägare"],
},
{
...
labels: ["Leverantör nr*","Namn*","Personnr","Mobil","Telefon","E-post","Roll"],
},
{
id: "ovrigt",
name: "Övrigt",
...
// --- demo seed data (trimmed: 2 of 10 entries kept) ---
const companySeeds = [
["Alvesta Byggservice AB","556417-9283","SE556417928301","3821-7456","Ångbåtsvägen 9","722 10","Västerås","info@alvestabyggservice.se","www.alvestabyggservice.se"],
["Vikens Plåt & Tak AB","556902-1754","SE556902175401","7740-6331","Industrigatan 4","263 61","Viken","faktura@vikenplat.se","www.vikenplat.se"],
];
...
["ADM", "Administratör projekt", "tim", 330, 425, "7210", "1150", "Nej", "Administration"],
...
["1005", "Klyv/bordssåg", "tim", 80, 125, "5600", "Ja", "Egna maskiner", 6, "1208"],
["1024", "Laseravståndsmätare Leica", "dygn", 45, 95, "5600", "Ja", "Verktyg", 7, "1212"],
["1038", "Byggställning 12 meter", "v", 1200, 1850, "5410", "Ja", "Egna maskiner", 2, "1220"],
["1051", "Fallskyddssele komplett", "dygn", 35, 80, "5400", "Ja", "Säkerhet", 12, "1230"],
["1067", "Betongblandare 160 liter", "dygn", 140, 260, "5600", "Ja", "Egna maskiner", 3, "1240"],
["1160", "Skyddsplast golv 50 m", "rle", 240, 365, "4010", "Ja", "Eget material", 34, "1250"],
];

const projectSeeds = [
["00","10001","Lundbergs ombyggnad","Beställt","Arne Andersson","2026-01-12","Fastpris","Byggservice","10005","Sofia Larsson","KST-174","Bygg","Arne Andersson","ROT","Entreprenad","Start efter materialleverans","2026-06-30","10","Stora gatan 18","Plan 2","Linköping"],
["10001","10002","Nattskrikan 12","Pågående","Sofia Larsson","2026-02-03","Löpande räkning","Totalentreprenad","10006","Karin Bergström","BRF-88","Service","James Scott","Service","Fasad","Etapp 2","2026-08-14","12","Tallvägen 7","","Norrköping"],
["00","10037","Åkersberga kontor","Nytt","Nora Sjöberg","2026-03-18","Fastpris","Arbetsorder","10007","Erik Lind","INK-552","Installation","Mehmet Kaya","Kommersiellt","El","Kundmöte bokat","2026-09-22","8","Stationsvägen 41","","Åkersberga"],
];
...
return [
{ label: "Ingen skattereduktion", value: "Ingen skattereduktion", type: "string" },
...
// valueFor(): ~150 lines of demo-value generation per label, omitted from this recovered copy.
// It maps each label to a seed field via regex (projektnr -> project[1], kundnr -> 10005+row, etc.)
// and exists only to produce realistic sample files. Not load-bearing logic.
...
// deliberately seeded defects, so the importer has something to catch:
...
// A second sheet of junk rows, to prove the importer can ignore non-data tabs:
const makeNoiseRows = () => [
{ Export: "Systeminfo", Värde: "NEXT legacy export", Status: "Ignored" },
{ Export: "Skapad av", Värde: "migration.service@kund.se", Status: "Ignored" },
...
{ Export: "Radnotis", Värde: "Den här fliken ska inte importeras", Status: "Ignored" },
...
addMessage(updates, column.key, value, "error",
`${cleanLabel(label)} är obligatoriskt enligt mallen.`);
}
if (isDateLabel(label)) {
addMessage(updates, column.key, value, "info",
...
addMessage(updates, column.key, value, "warning",
...
addMessage(updates, column.key, value, "error", "Värdet kan inte vara negativt.");
}
if (
...
(option) =>
String(option.value).toLowerCase() === String(value).trim().toLowerCase()
)
) {
addMessage(updates, column.key, value, "warning",
...
if (firstColumn) {
addMessage(updates, firstColumn.key, getValue(row[firstColumn.key]), "info",
...
{ step: 3, title: "Er verksamhet & bakgrund", subtitle: "Profil, geografi, SEO" },
...
// THE GATING RULE: step N unlocks only when step N-1 has completed.
...
await ImporterSession.verify({ identifier: definition.identifier }).catch(() => null);
...
XLSX.utils.book_append_sheet(workbook, dataSheet, definition.sheetName.slice(0, 31));
...
setCompleted((current) => ({ ...current, [definition.identifier]: true }));
...
<button className="lang-btn" type="button">Svenska ▾</button>
...
<div
className={`prep-item ${index === 1 ? "done" : index === 0 ? "active" : ""}`}
key={item.step}
>
<div className="prep-marker">{index === 1 ? "✓" : item.step}</div>
...
onClick={() => { if (!locked) setActiveIndex(index); }}
>
<div className="migration-index">
<div className="migration-bullet">
{completed[definition.identifier] ? "✓" : locked ? "🔒" : index + 1}
</div>
...
<span className="migration-name">{definition.name}</span>
{status === "complete" && (<span className="status-pill complete">Klar</span>)}
{status === "active" && (<span className="status-pill active">Redo</span>)}
{status === "locked" && (<span className="status-pill locked">Låst</span>)}
</div>
...
Ladda upp er Gi-mall och följ importordningen. Inget i flödet är ändrat,
endast gränssnittet har stylats om för att matcha mockupen.
</p>
</div>
<div className="hero-actions">
<button className="ghost-btn" type="button" onClick={() => downloadSample(activeDefinition)}>
...
<div>
<span className="overview-eyebrow">Gi-mall ({activeDefinition.shortName})</span>
<h2 className="overview-title">{activeDefinition.title}</h2>
<p className="overview-description">{activeDefinition.description}</p>
</div>
<div className="overview-badge">En Excel-fil med en flik per datatyp</div>
</div>
<div className="upload-showcase">
<div className="upload-showcase-inner">
<div className="upload-icon">📊</div>
<div className="upload-title">Ladda upp er Gi-mall (Excel)</div>
<div className="upload-copy">
Använd knappen högst upp för att starta den aktiva importören.
ImporterSession öppnas vid upload-steget och nästa steg låses upp
...
<div className="checklist-title">Förberedelser i processamordnaren</div>
<div className="checklist-item">
<span className="check-box" />
Vi har gått igenom projektstatusar. Endast projekt vi arbetar med och ska ha pågående.
</div>
<div className="checklist-item">
<span className="check-box" />
Alla övriga projekt har annan status, så de är avslutade och kommer inte med i importen.
</div>
<div className="checklist-item">
<span className="check-box" />
Vi förstår att enbart projekt med status Pågående migreras till Next.
</div>
</section>
...
{completedCount === sheetDefinitions.length ? "All complete" : "In progress"}
</span>
</div>
